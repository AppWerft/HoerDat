...
// in simulator we redefine to format for HrDat Developer console
...
{\
	NSString * exceptionName = [@"org.hrdat." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.hrdat";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIHrDatNativeItemNone = -1, 
	UIHrDatNativeItemSpinner = -2,
	UIHrDatNativeItemProgressBar = -3,
	
	UIHrDatNativeItemSlider = -4,
	UIHrDatNativeItemSwitch = -5,
	UIHrDatNativeItemMultiButton = -6,
	UIHrDatNativeItemSegmented = -7,
	
	UIHrDatNativeItemTextView = -8,
	UIHrDatNativeItemTextField = -9,
	UIHrDatNativeItemSearchBar = -10,
	
	UIHrDatNativeItemPicker = -11,
	UIHrDatNativeItemDatePicker = -12,
	
	UIHrDatNativeItemInfoLight = -13,
	UIHrDatNativeItemInfoDark = -14,
	
	UIHrDatNativeItemDisclosure = -15,
	
	UIHrDatNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all HrDat instances of
